...
import wiki.ganhua.hnapay.service.*;
import wiki.ganhua.hnapay.service.impl.AccountManageServiceImpl;
import wiki.ganhua.hnapay.service.impl.FileDownloadServiceImpl;
...
public abstract class BaseHnaPayServiceImpl implements HnaPayService {
    ...
    @Getter
    private final FileDownloadService fileDownloadService = new FileDownloadServiceImpl(this);
